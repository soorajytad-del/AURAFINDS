const products = [
  {
    id: "1001",
    title: "Disposable Razor For Men Pack of 3",
    tagline: "Surgical Skin Blade Use And Throw Shaving Razor With Safety Cap | Manual Beard And Face Grooming | Travel Friendly Stainless Steel Blade | ISO, CE Approved",
    category: "Fitness",
    price: 299,
    originalPrice: 499,
    rating: 4.3,
    ...
    amazonUrl: "https://link.amazon/B042tgUWg",
    features: [
    ...
    variants: [
      { name: "Pack of 3", price: 299, originalPrice: 499, amazonUrl: "https://link.amazon/B042tgUWg" }
    ],
    colors: [
