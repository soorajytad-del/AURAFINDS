const products = [
  {
    ...
    description: "The C-Cure Disposable Surgical Skin Razor is designed with a highly compact profile (7 cm x 4.5 cm) and a premium stainless steel single blade to support smooth, consistent shaving performance. Perfect for travel, gym bags, and daily grooming, it features a protective safety cap to cover the blade after use for safe, hygienic storage. As a convenient use-and-throw grooming option, it eliminates the need for cleaning or replacement blades, making it ideal for business trips, vacations, salons, and quick touch-ups on the go.",
    variants: [
